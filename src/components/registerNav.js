...
const RegisterNav = () => {
    ...
    return(
        ...
        <div className="container-fluid nav-mobile">
            <div className={`collapse cat-nav navbar-collapse d-flex align-items-center justify-content-between`} id="#navbarSupportedContent">
                <Link className="navbar-brand" to={`/`}><img src={require('../images/logo2.jpg')} alt='' className='img-register'/><span className='dig'>DIGI</span></Link>
                <div className='d-flex align-self-items justify-content-between'>
                    <div className='nav mobile-nav'>
                        <ul className='ul-nav nav d-flex align-items-center justify-content-between'>
                            ...
                            <li className='nav-item'><Link className={`nav-link nav-nav`} to='#top'>Be a manufacutrer</Link></li>
