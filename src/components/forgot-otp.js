    ...
    return(
        <main className='h-100 container'>
          <nav className='navbar navbar-expand-lg'>
            ...
            <form className='mt-3 mb-3 reg-form pt-4'>
              <div className='mb-2'>
              ...
              <p className='otp-p'>Did not get OTP after 10 minute  </p><a href='#top' className='resend'>RESEND</a>
              <button onClick={() => {navigate('/newpass')}} className='form-control join'>Continue</button>
            </form>
