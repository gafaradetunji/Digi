          ...
          <div className=''>
                <div className=''>
                    <div className='all-view'>
                        <Link to={`/editmanufacturer`} className='back-track d-flex align-items-center justify-content-between'>
            ...
            <form className='lg:w-[600px] mx-auto register-form' onSubmit={handleSubmit}>
              ...
              <div className='each-reg mb-2'>
                <label className="form-label">Estimated delivery period</label>
                <p className='error'>{formError.number}</p>
                <input type='text' placeholder='Type In Your Phone Number' name='number' className='form-control reg-input' value={values.number} onChange={handleChange}/>
              </div>
              <div className='each-reg mb-2'>
                <label className="form-label">Tracking and Insurance</label>
              ...
              <div className='each-reg mb-2'>
                <label className="form-label">Custom and stamp duties</label>
                <p className='error'>{formError.confirmPassword}</p>
                <input type='password' placeholder='Repeat Password Typed' name='confirmPassword' className='form-control reg-input' value={values.confirmPassword} onChange={handleChange}/>
              </div>
              <div className='each-reg mb-2'>
                <label className="form-label">Do you have a wharehouse</label>
                <p className='error'>{formError.confirmPassword}</p>
                <input type='password' placeholder='Repeat Password Typed' name='confirmPassword' className='form-control reg-input' value={values.confirmPassword} onChange={handleChange}/>
              </div>
              <div className='each-reg mb-2'>
              ...
              <button className='form-control join' onClick={() => {navigate('/policies')}}>continue</button>
            </form>
        </main>
    )
}
